...
import { rowDirection, leadingAlignment, textAlignStart, textAlignEnd } from '@/lib/rtl';
...
export default function FeedOrderDetail({ feedOrderId, onEdit }) {
  ...
  const compactTitle = t('batches.feedOrderDetail.feedOrder', 'Feed Order');
      ...
      >
        <Text
          style={[
            ...
            { flex: COL_PRODUCT, textAlign: textAlignStart(isRTL) },
          ]}
          numberOfLines={1}
        >
        ...
        <Text
          style={[
            tableStyles.headerCell,
            { flex: COL_AMOUNT, textAlign: textAlignEnd(isRTL) },
          ]}
          numberOfLines={1}
        >
